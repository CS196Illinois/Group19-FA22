        ...
        <div className="sentiment__line__graph">
            ...
            <div className="chart__period__wrapper">
                <div className="chart__period">
                    <div id="1D" className="sentiment__line__graph__period sentiment__line__graph__period__active" onClick={callOnClick}>1D</div>
                    <div id="5D" className="sentiment__line__graph__period" onClick={callOnClick}>5D</div>
                    <div id="1M" className="sentiment__line__graph__period" onClick={callOnClick}>1M</div>
                    <div id="6M" className="sentiment__line__graph__period" onClick={callOnClick}>6M</div>
                    <div id="1Y" className="sentiment__line__graph__period" onClick={callOnClick}>1Y</div>
