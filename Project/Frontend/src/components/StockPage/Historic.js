                ...
                <div className="historic__chart__wrapper">
                    ...
                    <div className="chart__period__wrapper">
                        <div className="chart__period">
                            <div className="historic__period historic__period__active" onClick={toggleActive}>1D</div>
                            <div className="historic__period" onClick={toggleActive}>5D</div>
                            <div className="historic__period" onClick={toggleActive}>1M</div>
                            <div className="historic__period" onClick={toggleActive}>6M</div>
                            <div className="historic__period" onClick={toggleActive}>1Y</div>
